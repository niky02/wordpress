...
/////////////////////////////////////////////////www.mobantu.com   82708210@qq.com
	if($_POST && $_POST['paytype'])
	{
		...
		{
			$url=constant("erphpdown")."payment/weixin/example/weixin.php?ice_money=".$wpdb->escape($_POST['ice_money']);
		}
		elseif(isset($_POST['paytype']) && $paytype==9)
	    {
	        $url=constant("erphpdown")."payment/xhpay.php?ice_money=".$wpdb->escape($_POST['ice_money']);
	    }
	    elseif(isset($_POST['paytype']) && $paytype==10)
	    {
	        $url=constant("erphpdown")."payment/xhpay2.php?ice_money=".$wpdb->escape($_POST['ice_money']);
	    }
