...
function wp_add_styles() {
  wp_register_style('wp_stylesheet',get_stylesheet_directory_uri().'/inc/shortcodes/shortcodes.css');
  wp_enqueue_style('wp_stylesheet');
}
add_action( 'wp_enqueue_scripts', 'wp_add_styles' );

//custom shortcodes js
function wp_add_scripts() {
  wp_register_script('wp_script', get_stylesheet_directory_uri().'/inc/shortcodes/shortcodes.js', array('jquery'),'2.0', true);
