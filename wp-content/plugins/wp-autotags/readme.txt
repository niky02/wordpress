...
Ps：后台通过  设置->撰写  页面对插件进行配置。TF-IDF关键词提取接口仅支持中文&英文文本。插件在PHP5.5及以上工作。
