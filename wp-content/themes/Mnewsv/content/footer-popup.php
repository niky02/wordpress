...
<?php } if(is_single()){
    $type   = get_post_type();
    $switch = $salong['switch_'.$type.'_tagshare'];
    if(!$switch)
        return;
?>
<!-- 文章微信二维码 -->
<a id="weixin_qr" class="overlay" rel="external nofollow" href="#m"></a>
<article class="weixin_qr popup">
    <section class="popup_main">
        ...
        <a class="close" rel="external nofollow" href="#m"><?php echo svg_close(); ?></a>
        <script type="text/javascript">$("#qrcode").qrcode({width:258,height:258,text:"<?php the_permalink(); ?>"});</script>
    </section>
</article>
<?php } ?>
