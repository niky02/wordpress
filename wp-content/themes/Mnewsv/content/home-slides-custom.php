...
?>
<?php $args=array( 'post_type'=> 'post','posts_per_page' => $sticky_count,'ignore_sticky_posts' => 1,'post__in'=> get_option('sticky_posts'));$temp_wp_query = $wp_query;$wp_query = null;$wp_query = new WP_Query( $args );if ( $wp_query->have_posts() && $salong['switch_home_sticky'] ) : ?>
