...
<section class="slick_sticky">
    ...
    <?php $args=array( 'post_type'=> 'post','posts_per_page' => 4,'ignore_sticky_posts' => 1, 'post__not_in' => $do_not_duplicate,'post__in'=> get_option('sticky_posts'));$temp_wp_query = $wp_query;$wp_query = null;$wp_query = new WP_Query( $args );if ( $wp_query->have_posts() ) : ?>
