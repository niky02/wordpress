    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3 widget--about">
            <div class="widget--content">
                <div class="footer--logo mb-20">
                    <img class="tap-logo" src="<?php echo esc_url(_cao('site_footer_logo')); ?>"
                         data-dark="<?php echo esc_url(_cao('site_footer_logo')); ?>"
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 widget--newsletter">
            ...
            <div class="widget--content">
                ...
                <h6>
                    <div class="payment">
                        <?php if (_cao('is_footer_search_bottom')) {
                            $footer_search_bottom_info = _cao('footer_search_bottom_info');
                            foreach ($footer_search_bottom_info as $item) {
                                echo '<img class="icon icon-v6 icon-v6-stripe" src="' . $item['_img'] . '" title="' . $item['_title'] . '">';
                            }
                        }
                        ?>
                    </div>
