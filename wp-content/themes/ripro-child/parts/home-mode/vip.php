			...
			<?php foreach ( $home_mode_vip['vip_group'] as $item ) : ?>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3">
			        <div class="vip-cell">
                        ...
                        <div class="content index_vip_in"><?php echo $item['_desc'];?></div>
						<?php if (is_user_logged_in()) : ?>
						<a href="<?php echo esc_url(home_url('/index.php/user?action=vip'));?>" class="btn-sm primary" style="background:<?php echo $item['_color'];?>"><i class="fa fa-unlink"></i> 前往开通</a>
						<?php else: ?>
